...
extension NumbersExt on num {
  /// Loading.
  Widget get darkLoading => LoadingAnimationWidget.staggeredDotsWave(size: toDouble(), color: AppColors.lightBlueColor);

  Widget get lightLoading => LoadingAnimationWidget.staggeredDotsWave(size: toDouble(), color: AppColors.lightParchmentToneColor);
...
extension TextExt on String {
  /// Toast.
  Future<bool?> get showToast => Fluttertoast.showToast(msg: this, textColor: AppColors.lightParchmentToneColor, backgroundColor: AppColors.blackColor);
}
