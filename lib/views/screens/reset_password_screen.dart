                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const HeroWidget(
                          ...
                          child: Text(AppStrings.resetPasswordText, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.lightParchmentToneColor)),
                        ),
                        10.gap,
                        HeroWidget(
                                  ...
                                  child: Container(
                                    ...
                                    child:
                                        controller.isLoading
                                            ? 30.lightLoading
                                            : const Text(AppStrings.resetPasswordText, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.lightParchmentToneColor)),
                                  ),
                                );
                              },
                            ),
                        ...
                        HeroWidget(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              const Text(AppStrings.doNotHaveAnAccountText + AppStrings.spaceSign, style: TextStyle(fontSize: 16, color: AppColors.lightParchmentToneColor)),
                              InkWell(
